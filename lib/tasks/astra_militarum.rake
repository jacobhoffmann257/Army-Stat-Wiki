desc "astra militarum data"
  namespace :slurp do
    task astra_militarum_stats: :environment do 
      require "csv"
      require "json"
      #Stats
    ...
    task astra_militarum_weapons: :environment do 
    ...
    task astra_militarum_abilities: :environment do
      csv_ability = File.read(Rails.root.join("lib", "sample_data", "astra-militarum_abilities2.csv"))
